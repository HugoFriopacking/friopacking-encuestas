const encuesta = {
  ...
  preguntas: [
    ...
    { id: 's2', tipo: 'seccion', texto: 'Logística', icono: 'logistica' },
    ...
    { id: 's3', tipo: 'seccion', texto: 'Administración y Finanzas', icono: 'finanzas' },
    ...
    { id: 's4', tipo: 'seccion', texto: 'Frioteam', icono: 'frioteam' },
    ...
    { id: 's6', tipo: 'seccion', texto: 'Ingeniería', icono: 'ingenieria' },
